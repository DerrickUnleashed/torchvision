...
search_collection("cell")        # Find cell-related datasets
search_collection("solar")       # Find solar panel datasets
search_collection("x-ray")       # Find X-ray datasets

\n# List all datasets in a collection\nsearch_collection(collection = "biology")\nsearch_collection(collection = "medical")\n\n# View complete catalog\ncatalog <- get_collection_catalog()\nView(catalog)\n```
